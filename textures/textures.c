...
unsigned int texture[4]; // Textures Array
...
static void house(double x, double y, double z,
 ...
 //Base of the House 
  glBindTexture(GL_TEXTURE_2D,texture[0]); // Brick
  glBegin(GL_QUADS);
  //Front
  glNormal3f( 0, 0, 1);
...
//Roof sections
  ...
  // Front
  glNormal3f(0,0,+1);
  glTexCoord2f(0, 0); glVertex3f(+width,+bottom,+length);
  glTexCoord2f(5, 0); glVertex3f(-width,+bottom,+length);
  glTexCoord2f(2, 5); glVertex3f(0,+height,+length/3);
  // Back
  glNormal3f(0,0,-1);
  glTexCoord2f(0, 0); glVertex3f(+width,+bottom,-length);
  glTexCoord2f(5, 0); glVertex3f(-width,+bottom,-length);
  ...
  glTexCoord2f(0, 0); glVertex3f(+width,+bottom,-length);
  glTexCoord2f(5, 0); glVertex3f(+width,+bottom,+length);
  glTexCoord2f(5, 5); glVertex3f(-width,+bottom,+length);
  glTexCoord2f(0, 5); glVertex3f(-width,+bottom,-length);
  // Right side
  glNormal3f(+1,+1,0);
  glTexCoord2f(0, 0); glVertex3f(+width,+bottom,-length);
  glTexCoord2f(5, 0); glVertex3f(+width,+bottom,+length);
  glTexCoord2f(5, 5); glVertex3f(0,+height,+length/3);
  glTexCoord2f(0, 5); glVertex3f(0,+height,-length/3);
  // Left Side
  glNormal3f(-1,-1,0);
  glTexCoord2f(0, 0); glVertex3f(-width,+bottom,-length);
  glTexCoord2f(5, 0); glVertex3f(-width,+bottom,+length);
...
int main(int argc,char* argv[])
{
   ...
   texture[1] = LoadTexBMP("shingleblack.bmp");
   texture[2] = LoadTexBMP("Rockport_Door.bmp");
